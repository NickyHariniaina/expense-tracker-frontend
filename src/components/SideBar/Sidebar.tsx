...
const Sidebar: React.FC = () => {
  ...
  const displayName = userData?.email
    ? userData.email.split("@gmail.com")[0]
    : "Utilisateur";
  ...
  const getLinkClasses = (path: string) => {
    ...
    return `flex items-center space-x-2 px-4 py-4 rounded-lg transition-colors ${
      isActive
        ? "secondary-color text-white font-semibold"
        : "neutraly-color text-white hover:bg-secondary-color hover:text-white hover:font-semibold"
    }`;
  };

  return (
    <aside className="z-100 w-64 h-screen bg-white flex flex-col gap-20 p-5 fixed left-0">
      ...
      <div className="flex flex-col items-center space-y-2">
        ...
        <p className="text-xl font-medium capitalize text-green">
          {displayName}
        </p>
      </div>
        ...
        <ul className="space-y-2">
          ...
          <li>
            <NavLink
              ...
              className={getLinkClasses("/dashboard/expense")}
            >
          ...
          <li>
            <NavLink
              to="/dashboard/income"
              className={getLinkClasses("/dashboard/income")}
            >
          ...
          <li>
            <NavLink
              ...
              className={getLinkClasses("/dashboard/category")}
            >
          ...
          <li>
            <NavLink
              ...
              className={getLinkClasses("/dashboard/summary")}
            >
