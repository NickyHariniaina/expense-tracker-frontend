    ...
    <div className="p-6 space-y-6 text-gray-900">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            >
              ...
              {summary?.expensesByCategory &&
                Object.keys(summary.expensesByCategory).map((cat) => (
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="p-6 rounded-2xl shadow-xl border-l-4 border-blue-500 bg-gradient-to-r from-blue-400/25 to-blue-500/10 backdrop-blur-md">
          ...
          <p
            className={`text-2xl font-bold ${(summary?.balance ?? 0) >= 0 ? "text-green-700" : "text-red-700"}`}
          >
            Ariary {(summary?.balance ?? 0).toFixed(2)}
          </p>
